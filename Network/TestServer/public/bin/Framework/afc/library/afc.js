...
afc.makeMeta = function()
{
	...
	if(PROJECT_OPTION.general.autoScale)
	{
		...
		else
		{
			...
			if(!scale) scale = chkWidth / PROJECT_OPTION.general.docWidth;
	...
	{ 
		var docWidth = PROJECT_OPTION.general.docWidth;
	...
	if(PROJECT_OPTION.general.userScalable) meta += ', user-scalable=yes"/>';
