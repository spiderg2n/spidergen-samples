...
ADataGrid.prototype.init = function(context, evtListener)
{
	...
	//데이터 그리드는 clearRowTemplate을 해제할 수 없다. 런타임시점에는 전체로우 제거한다.
	this.grid.setAttr('data-clear-rowtmpl', true);
	...
	if(this.option.isPivotGrid) 
	{
		...
		this.pivotGrid.setAttr('data-clear-rowtmpl', true);
...
ADataGrid.prototype.setGridData = function(dataArr2, updateType, isFiltered)
{
	...
	if(!isFiltered) this.maskGridData(dataArr2);
...
ADataGrid.prototype.setFilteredData = function(filterData, updateType)
{
...
ADataGrid.prototype.filter = function(filterFunc, updateType)
{
	...
	this.setFilteredData(arr, updateType);
};
