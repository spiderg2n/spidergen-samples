...
AApplication.prototype.onReady = function()
{
	...
	//var rootTag = 'body';
	//if(PROJECT_OPTION.build.subName) rootTag = '.' + PROJECT_OPTION.build.subName;
	var rootTag = '._global_style_';
	
	this.rootContainer.init($(rootTag)[0], true);	//default is body
...
AApplication.prototype.loadThemeInfo = function()
{
    ...
    $.ajax(
    {
        url: 'Template/Theme/themeInfo.inf',
        dataType: 'text',
...
AApplication.prototype.changeTheme = function(theme)
{
	...
	if(curTheme != theme)
	{
		...
		this.reportThemeEvent(activeTheme, theme);
	}
};
